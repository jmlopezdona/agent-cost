...
describe('casos dorados P1 y P4', () => {
  it('P1: blend Opus-heavy en régimen 8×5 supervisado', () => {
    const results = computeResults(P1, pricingTable)
    // 0,9 × 23,7725 + 0,1 × 4,7545 = 21,8707 $/h
    expect(results.blendedRate).toBeCloseTo(21.8707, 4)
    expect(results.ceilingMonthlyUSD).toBeCloseTo(21.8707 * 40 * (52 / 12), 2)
