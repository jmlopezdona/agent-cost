...
export const strings = {
  ...
  charts: {
    ...
    breakdownHint: 'USD por hora activa del blend actual',
    categories: {
  ...
  salary: {
    ...
    fxUnit: '€ por USD',
    agentMonthly: (eur: string) => `Coste ponderado del escenario: ${eur}/mes`,
    agentPerHour: (eur: string) => `€/h activa del agente: ${eur}`,
  ...
  footer: {
    ...
    pricingLink: 'Tabla oficial de precios de Anthropic',
