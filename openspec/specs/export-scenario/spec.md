...
Exportación 100% en cliente del escenario activo y sus visualizaciones, sin que ningún dato salga del navegador: escenario como CSV y JSON, cada gráfico como PNG individual y un montaje único PNG con las tres visualizaciones.
