...
Modo presentación con vista limpia apta para proyectar: oculta los controles y muestra solo nombre, descripción y `learnings` del escenario, las tarjetas de métricas y las visualizaciones con tipografía ampliada. Conmutable por clic y activable vía URL (`present=1`).
