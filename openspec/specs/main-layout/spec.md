...
Disposición de la pantalla principal en escritorio y móvil: una columna de configuración con acordeón exclusivo (Régimen y utilización, Mezcla de modelos, Tasa de tokens E/S y Configuración avanzada), una zona de resultados cuyos gráficos se presentan en un sistema de pestañas y una comparativa salarial a todo el ancho situada por debajo del resto de secciones. El estado de presentación de la UI (sección abierta y pestaña activa) es estado de interfaz y no se persiste.
