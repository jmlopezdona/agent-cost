...
La UI DEBE ofrecer tres sliders de mezcla (Fable, Opus, Sonnet) y calcular Haiku como resto hasta 100%, con clamping bidireccional que impida que la suma supere 100% (RF-03).

#### Scenario: Haiku como resto

- **WHEN** el usuario fija Fable 0%, Opus 15% y Sonnet 65%
...
La UI DEBE mostrar la tarifa $/hora activa resultante de cada modelo y la tarifa del blend actual (CA-03.1).

#### Scenario: Tarifas visibles al ajustar la mezcla

- **WHEN** el usuario modifica cualquier slider de mezcla
- **THEN** las tarifas por modelo permanecen visibles y la tarifa blend se actualiza al instante
