...
|---|---|---|---|---|---|---|---|---|---|---|
| P1 | Pair programming supervisado | Un desarrollador trabaja con un agente tipo Claude Code en sesión interactiva. El humano revisa y aprueba; el agente pasa la mayor parte del tiempo esperando. Perfil de tokens representativo de una sesión interactiva de desarrollo. | 42 | 210 | 30 | 530 | 0/90/0/10 | 8×5 | 30% | 1 |
...
| P4 | Sonnet-first con escalación | Mantenimiento y evolutivos sobre código maduro: Sonnet resuelve la mayoría de tareas y Opus solo entra como escalación cuando el agente se atasca. Haiku absorbe el trabajo trivial. Alta autonomía. | 42 | 190 | 28 | 500 | 0/5/55/40 | 24×7 | 70% | 1 |
| P5 | Enjambre QA nocturno | Flota de agentes de testing (personas sintéticas, regresión E2E, evals) que corre fuera de horario. Haiku-heavy, contextos cortos, candidato ideal a Batch API (−50%) por no requerir latencia. | 25 | 120 | 12 | 300 | 0/0/30/70 | 12×7 | 85% | 5 |
